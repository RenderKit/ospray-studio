// copied MainWindow.cpp and used "devel" namespace
...
void MultiWindows::start()
{
  std::cerr << "MULTIWINDOWS mode\n";
...
MultiWindows *MultiWindows::getActiveWindow()
{
  return activeWindow;
}

std::shared_ptr<sg::Frame> MultiWindows::getFrame()
{
  return frame;
}

void MultiWindows::registerDisplayCallback(
    std::function<void(MultiWindows *)> callback)
{
  displayCallback = callback;
}

void MultiWindows::registerKeyCallback(std::function<void(
        MultiWindows *, int key, int scancode, int action, int mods)> callback)
{
  keyCallback = callback;
}

void MultiWindows::registerImGuiCallback(std::function<void()> callback)
{
  uiCallback = callback;
}

void MultiWindows::mainLoop()
{
...
void MultiWindows::reshape(const vec2i &newWindowSize)
{
...
void MultiWindows::updateCamera()
{
  frame->currentAccum = 0;
  auto camera = frame->child("camera").nodeAs<sg::Camera>();
...
void MultiWindows::centerOnEyePos()
{
...
void MultiWindows::pickCenterOfRotation(float x, float y)
{
...
void MultiWindows::keyboardMotion()
{
...
void MultiWindows::changeToDefaultCamera()
{
...
void MultiWindows::motion(const vec2f &position)
{
...
void MultiWindows::mouseButton(const vec2f &position)
{
  if (frame->pauseRendering)
    return;
...
void MultiWindows::mouseWheel(const vec2f &scroll)
{
...
void MultiWindows::startNewOSPRayFrame()
{
  frame->startNewFrame();
}

void MultiWindows::waitOnOSPRayFrame()
{
  frame->waitOnFrame();
}

void MultiWindows::updateTitleBar()
{
...
GLFWwindow *MultiWindows::getGLFWWindow()
{
  return glfwWindow;
}

void MultiWindows::buildUI()
{
...
void MultiWindows::refreshRenderer()
{
...
void MultiWindows::saveRendererParams()
{
  auto &r = frame->childAs<sg::Renderer>("renderer");
...
void MultiWindows::refreshScene(bool resetCam)
{
  if (frameAccumLimit)
...
void MultiWindows::importFiles(sg::NodePtr world)
{ 
...
void MultiWindows::saveCurrentFrame()
{
  int filenum = 0;
  char filename[64];
...
void MultiWindows::pushLookMark()
{
...
void MultiWindows::buildMainMenu()
{
...
void MultiWindows::buildMainMenuFile()
{
...
void MultiWindows::buildMainMenuEdit()
{
...
void MultiWindows::buildMainMenuView()
{
...
void MultiWindows::buildMainMenuPlugins()
{
...
void MultiWindows::buildWindows()
{
...
void MultiWindows::buildWindowRendererEditor()
{
  if (!ImGui::Begin(
...
void MultiWindows::buildWindowFrameBufferEditor()
{
  if (!ImGui::Begin(
...
void MultiWindows::buildWindowKeyframes()
{
...
void MultiWindows::setCameraSnapshot(size_t snapshot)
{
...
void MultiWindows::buildWindowSnapshots()
{
...
void MultiWindows::buildWindowLightEditor()
{
...
void MultiWindows::buildWindowCameraEditor()
{
...
void MultiWindows::buildWindowMaterialEditor()
{
...
void MultiWindows::buildWindowTransferFunctionEditor()
{
...
void MultiWindows::buildWindowIsosurfaceEditor()
{
...
void MultiWindows::buildWindowTransformEditor()
{
...
void MultiWindows::buildWindowRenderingStats()
{
  ImGuiWindowFlags flags = ImGuiWindowFlags_NoDecoration
      | ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoSavedSettings
      | ImGuiWindowFlags_NoFocusOnAppearing | ImGuiWindowFlags_NoNav
