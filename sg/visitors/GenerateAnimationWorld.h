...
struct GenerateAnimationWorld : public Visitor
{
  GenerateAnimationWorld() = default;
  ~GenerateAnimationWorld() override = default;
...
inline bool GenerateAnimationWorld::operator()(
