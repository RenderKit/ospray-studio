...
{
  createChild("position0", "vec3f", "position of the start of the cylinder", vec3f(0.f));
  createChild("position1", "vec3f", "position of the end of the cylinder", vec3f(0.f, 0.f, 1.f));
