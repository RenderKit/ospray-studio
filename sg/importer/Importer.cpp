...
void importScene(
    std::shared_ptr<StudioContext> context, JSON j, std::string filesToImportDir = "")
{
...
OSPSG_INTERFACE void importScene(
    std::shared_ptr<StudioContext> context, std::string json, std::string filesToImportDir)
{
  JSON j;
  j = JSON::parse(json);
